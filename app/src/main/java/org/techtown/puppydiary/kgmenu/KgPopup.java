...
import org.techtown.puppydiary.network.Response.ShowKgMonthResponse;
...
import static org.techtown.puppydiary.kgmenu.KgTab.*;
...
public class KgPopup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        weight = (EditText)findViewById(R.id.kg_weight);
        ...
        final Call<ShowKgMonthResponse> getCall = service.showkgmonth(token, year, month);
        getCall.enqueue(new Callback<ShowKgMonthResponse>() {
            @Override
            public void onResponse(Call<ShowKgMonthResponse> call, Response<ShowKgMonthResponse> response) {
                ShowKgMonthResponse result = response.body();
                if(response.isSuccessful()){
                    //Toast.makeText(KgPopup.this, "kg 불러오기성공."+ kg, Toast.LENGTH_SHORT).show();
                    assert result != null;
                    kg = result.getData();
                    weight.setText(kg);
                }
            ...
            @Override
            public void onFailure(Call<ShowKgMonthResponse> call, Throwable t) {
                Toast.makeText(KgPopup.this, "kg 불러오기 싪패.", Toast.LENGTH_SHORT).show();
        ...
        close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DeleteKG();
                Intent intent_kgclose = new Intent(getApplicationContext(), KgTab.class);
    ...
    private void DeleteKG(){
        //토큰 넘겨줌
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        String token = sp.getString("TOKEN", "");
        service.kgdelete(token, year, month).enqueue(new Callback<kgDeleteResponse>() {
            @Override
